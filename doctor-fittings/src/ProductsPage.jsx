...
const PRODUCT_CATEGORIES = [
  { name: "Sliding Window Lock", image: catSlidingLock },
  { name: "Dumal Window Sliding Rollers", image: catDumalRollers },
  { name: "UPVC Sliding Roller", image: catUPVC },
  { name: "Window Sliding Rollers (Premium)", image: catPremiumRollers },
  { name: "Window Sliding Rollers (Economy)", image: catPremiumRollers },
  { name: "G & C Channel Door Sliding System", image: catGCChannel },
  { name: "Window & Door Handle", image: catWindowDoorHandle },
  { name: "Concealed Door Closer", image: catConcealedDoorCloser },
  { name: "Butt Hinges", image: catButtHinges },
  { name: "Corner Cleat Joints", image: imgCorner },
  { name: "Stainless Steel Wire Mesh", image: catSSMesh },
];
